...
storiesOf("DayListItem", module) //Initiates Storybook and registers our DayListItem component
  ...
  .add("Unselected", () => (
    <DayListItem setDay={action("setDay")} name="Monday" spots={5} />
  )) // To define our stories, we call add() once for each of our test states to generate a story
  .add("Selected", () => (
    <DayListItem setDay={action("setDay")} name="Monday" spots={5} selected />
  ))
  .add("Full", () => (
    <DayListItem setDay={action("setDay")} name="Monday" spots={0} full />
  ))
  .add("Clickable", () => (
  ...
  .add("Appointment Booked", () => (
    <Fragment>
      <Appointment
        id={1}
        time="4pm"
        interview={{ student: "Jogendra Biswas", interviewer }}
      />
      <Appointment time="5pm" />
    </Fragment>
  ));
